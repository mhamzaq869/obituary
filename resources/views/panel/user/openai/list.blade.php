                    ...
                    <ul
                        ...
                        @foreach ($filters as $filter)
                            @if (in_array($filter->name, $filter_check))
                                <li>
                                    <button data-filter-trigger="{{ $filter->name }}"
            ...
            <div class="row ml-45">
                <section>
                    ...
                    <div class="text-left my-3">
                        <button type="button" class="button btn btn-primary text-white" id="next">Next &rarr;</button>
                    </div>

                </section>

                <section style="display: none; transform: translateX(100px);">
                    @php
                    ...
                    @foreach ($list as $item)
                        ...
                        <div data-filter="{{ $item->filters }}"
                            ...
                            @if ($item->active == 1)
                                @if (!$upgrade)
                                    <a onclick="return favoriteTemplate({{ $item->id }});"
                                        id="favorite_area_{{ $item->id }}"
                                ...
                                <div
                                    ...
                                    @if ($upgrade)
                                        <div
                                            class="absolute right-2 top-2 z-10 bg-[#E2FFFC] text-black font-medium py-0.5 px-2 rounded-md">
                                            {{ __('Upgrade') }}
                                        </div>
                                    ...
                                    @else
                                        <div
                                            ...
                                            <a href="#" disabled=""
                                                class="bg-white pointer-events-none btn text-dark cursor-default">
                                                {{ __('No Tokens Left') }}
                                            </a>
                                        </div>
                                    @endif
